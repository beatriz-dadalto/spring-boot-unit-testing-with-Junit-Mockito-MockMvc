...
public class GradebookControllerTest {
    ...
    public void deleteStudentHttpRequest() throws Exception {
        ...
        // initially had 1 student but it was deleted. verify array size 0
    ...
    @DisplayName("Student id does not exist")
    @Test
    ...
    @DisplayName("Student id doesn't exist")
    @Test
    ...
    @Test
    public void deleteNonValidGardeHttpRequest() throws Exception {
